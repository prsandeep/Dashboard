...
function BugzillaDashboard() {
  ...
  const dashboardId = '6eec0f93-0749-4b9a-b756-24dab4ede81b';
...
//     const embedSupersetDashboard = async () => {
//       try {
//         const response = await axios.post('http://10.226.25.31:8088/api/superset/guest-token', {
...
//   return (
//     <div className="App">
//       {loading && <p style={{ color: '#555', position: 'absolute', top: 10, left: 10 }}>Loading dashboard...</p>}
//       {error && <p style={{ color: 'red', position: 'absolute', top: 10, left: 10 }}>Error: {error}</p>}
...
//   dashboardId = "6eec0f93-0749-4b9a-b756-24dab4ede81b",
...
// function BugzillaDashboard() {
//   const dashboardId = '474d01ec-d947-44fc-b368-2d0848de6c12';
//   const containerRef = useRef(null);
//   const [loading, setLoading] = useState(true);
//   const [error, setError] = useState(null);
